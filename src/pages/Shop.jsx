    ...
    return (
      <Box
        sx={{
          ...
          width: '100%',
          height: '100%',
          backgroundColor: themeMode === 'light' ? 'rgba(255, 255, 255, 0.8)' : 'rgba(15, 23, 42, 0.8)',
          display: 'flex',
    ...
    <Container maxWidth="xl" sx={{ pb: 8 }}>
      <Paper
        ...
        sx={{
          ...
          background:
            themeMode === 'light'
              ? 'linear-gradient(120deg, rgba(40,116,240,0.12) 0%, rgba(63,81,181,0.08) 100%)'
              : 'linear-gradient(120deg, rgba(30,64,175,0.15) 0%, rgba(15,23,42,0.5) 100%)',
        }}
      >
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
            <ToggleButtonGroup value={viewFilter} exclusive onChange={handleViewChange} size="small">
              <ToggleButton value="all">
                <FilterAltIcon fontSize="small" sx={{ mr: 0.5 }} /> {t('allProducts')}
              </ToggleButton>
              <ToggleButton value="inStock">{t('inStock')}</ToggleButton>
            ...
            <FormControl size="small" sx={{ minWidth: 160 }}>
              ...
              <Select labelId="sort-label" id="sort-select" value={sortOption} label={t('sortBy')} onChange={handleSortChange}>
                <MenuItem value="featured">{t('sortFeatured')}</MenuItem>
      ...
      <Paper elevation={0} sx={{ p: { xs: 2, md: 3 }, borderRadius: 4, mb: 4 }}>
        ...
        <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
          <Chip label={t('allProducts')} color={categoryFilter === 'all' ? 'primary' : 'default'} onClick={() => handleQuickSelect('all')} />
        ...
        <FormControl fullWidth size="small">
          <InputLabel id="category-filter-label">{t('filterByCategory')}</InputLabel>
          <Select labelId="category-filter-label" id="category-filter" value={categoryFilter} label={t('filterByCategory')} onChange={handleCategoryChange}>

...
const shippingSteps = [
  {
    ...
    summary: 'Inventory is allocated instantly and you receive your confirmation email with the XY order number.',
    details: [
    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 10 } }}>
      <Stack spacing={3} alignItems="center" textAlign="center" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680 }}>
          Precision logistics, proactive updates, and a no-drama return policy make gearing up with Xylo Electronics effortless.
        </Typography>
      </Stack>
